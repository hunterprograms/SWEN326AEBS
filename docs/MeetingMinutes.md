# Meeting Minutes — SWEN326 AEBS Project

## Meeting Saturday 09/05/26 - Commenced 11:31
### Scribe - Frank Quigley : 300660873

11:31 - Hunter Fromont, Frank Quigley commence meeting

Reviewing group agreement, finalised changes and signed
Began documentation amd breaking down planning phase
Decided each person will contribute to every segment
This means each group member will need to conduct a HARA analysis, construct a fault tree, create requirements and testing plans...

12:26 Perry Cooling joined meeting 

Split planning phase amongst group members allocating components for HARA, Safety Requirement, and Verification Standard development.

13:20 Specified a requirement identification format 
